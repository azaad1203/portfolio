...
<body>
	...
	<%
		String questioncontent = request.getParameter("question_content") ;
			...
			int questionid = Integer.parseInt(qsid) ;			//  converting string to an integer
	%>
	<%
		FileEditor MyEditor = new FileEditor();
			MyEditor.editQuestion(request.getRealPath("/request&answer.txt"), request.getRealPath("/temp.txt"), questioncontent, questionid);
		
			out.println("The edited question have been submitted succesfully.") ;
	%>
