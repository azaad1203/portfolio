...
<body>
	...
	<div class="main_home">
		...
		%>
				...
				<h3 style="height: 35px">Admin Answering</h3>
			
	
				
				<h2>Edit Question. <%= questionid+1%></h2>
				<p><%= question%></p>
				<p><strong>You can edit the question below. </strong></p>
				
				<form action="submiteditquestion.jsp" method="post">
					<textarea name="question_content" maxlength="5000" style="height: 300px; width: 550px; background-color: #E0E0E0" required="required"><%=question %></textarea>
