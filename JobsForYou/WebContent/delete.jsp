		...
		<div class="content2">
			...
			<%
				FileEditor MyEditor = new FileEditor();
					MyEditor.deleteItem(request.getRealPath("/request&answer.txt"), request.getRealPath("/temp.txt"), "r", questionid);
					
					out.println("Question " + (questionid+1) + " have been deleted.") ;
			%>
