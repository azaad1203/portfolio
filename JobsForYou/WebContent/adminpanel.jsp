<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	import = "java.util.*" import = "myPackage.FileReaders" import = "myPackage.Engine"
		...
		<div class="content2">
			...
			<%
				String username = request.getParameter("user_name") ;
						...
						if (!username.equals("Admin") || !password.equals("admin")){		//chacking username and password
			%>
						<h2>Wrong username or password.</h2><br>							<!-- handle worng password or username -->
						<input type="button" value="BACK" onClick="forum.jsp">
					<%
						}
										else{
					%>
						...
						><b>You can answer, edit or delete requests below</b></marquee>
						<hr>
						...
						<%
							...
							<col style="background-color:	#FFCCCC" />
								...
								%>
										...
										<td><form action="editquestion.jsp"><input type="hidden" name="question_ID" value="<%=i%>"><input type="submit" value="Edit"></form></td>
										<td><form action="delete.jsp"><input type="hidden" name="question_ID" value="<%=i%>"><input type="submit" value="Delete"></form></td>
										<td><%=answers.get(i)%></td>
										<td><form action="answer.jsp" method="post"><input type="hidden" name="question_ID" value="<%=i%>"><input type="submit" value="Answer"></form></td>
										</tr>
										<%
									}
								%>
