...
<body>
   ...
   <div style="position:absolute; padding:15px; height:auto; width:1000px; background-color:#ffebcc;  ">
       ...
       <div style="border-left: 6px solid #1a1aff; background-color:#cce0ff;">
      ...
      <asp:GridView ID="gvProducts" runat="server" Width="600px"
          ...
          <Columns>
              ...
              <asp:BoundField DataField="Product_name" HeaderText="Product Name" 
                 InsertVisible="False" ReadOnly="True" SortExpression="Product_name" />
              <asp:BoundField DataField="Product_price" HeaderText="Product Price" 
                 InsertVisible="False" ReadOnly="True" SortExpression="Product_price" />
              <asp:Imagefield DataImageUrlField="Product_image" 
                HeaderText="Product Image" InsertVisible="False" ReadOnly="True">  
              </asp:ImageField>
